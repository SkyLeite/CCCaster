...
INCLUDES += -I$(CURDIR)/3rdparty/d3dhook -I$(CURDIR)/3rdparty/framedisplay -I$(CURDIR)/3rdparty/imgui -I$(CURDIR)/3rdparty/imgui/backends -I$(CURDIR)/3rdparty/steam
...
LD_FLAGS += -L$(CURDIR)/3rdparty/steam/redist -lsteam_api
